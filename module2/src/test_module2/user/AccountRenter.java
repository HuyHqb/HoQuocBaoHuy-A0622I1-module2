...
public class AccountRenter extends Account {
    ...
    public void AccountRenter(String string) {
...
//        setStatus(data[4]);
    ...
    public String getInfo() {
        return getIdCard() + " , " + getFullName() + " , " + getBirthday() + " , " + getGender() + " , " + isStatus() + " , " + getMinArea() + " , " + getMaxArea() + " , " + getMinPrice() + " , " + getMaxPrice();
    }
}
